    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "AMS Logistics uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'c06489c1-e3cc-4369-9f40-3586255d8468',
                    name: data.name || '',
                    email: data.email || '',
